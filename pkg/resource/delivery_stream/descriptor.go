...
const (
	FinalizerString = "finalizers.firehose.services.k8s.aws/DeliveryStream"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("deliverystreams")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DeliveryStream{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DeliveryStream),
	}
}
