...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.DeliveryStreamName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["deliveryStreamName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: deliveryStreamName"))
	}
	r.ko.Spec.DeliveryStreamName = &f0
